...
function setup() {
  ...
  return [
    ...
    'Question 2 only applies to languages that have a formal and an informal register. If',
    'theirs does not (English, for example), skip it silently and leave address unset.',
    'Open by telling them how many quick questions there are — seven, or six when question 2',
    'does not apply — and that they can say "the rest as default" at any point to stop early.',
    '',
